...
- 日本国内の実在上場企業10社を `public_demo` として追加しました。対象は製造業、小売、物流、鉄道、不動産、通信・データセンター関連、医薬、化学、インフラ・エネルギーの分散を意識して選定しています。
- 実在企業デモは、公式IRサイトで確認できる有価証券報告書、統合報告書、決算資料、Financial Report 等の公開情報に基づく短い要約を入力データにしています。長い著作物本文は保存していません。
- `documents` には資料名、資料種別、対象年度、`source_url`、取得日時、出典メモを保持します。UIとレポートから資料名とURLを確認できます。
- `data_source_type` は `synthetic`（合成デモデータ）または `public_demo`（公開情報ベースの実在企業デモデータ）です。ダッシュボードではデータ種別フィルタで切り替えできます。
...
|---|---|---|---|
| トヨタ自動車株式会社 | 輸送用機器 | https://global.toyota/jp/ir/library/securities-report/index.html | 国内最大級の製造業で、工場・研究開発・脱炭素投資などCRE論点が幅広い。 |
| 株式会社セブン＆アイ・ホールディングス | 小売業 | https://www.7andi.com/en/ir/file/library/pdf/25_7andi_int04_en.pdf | 店舗網・物流・事業ポートフォリオ見直しの観点で小売CRE仮説を示しやすい。 |
| NIPPON EXPRESSホールディングス株式会社 | 陸運業 | https://www.nipponexpress-holdings.com/ja/ir/library/securities/ | 物流施設、倉庫ネットワーク、サステナビリティ投資のCRE論点が明確。 |
| 東日本旅客鉄道株式会社 | 鉄道 | https://www.jreast.co.jp/e/investor/securitiesreport/pdf/securitiesreport_fiscal2025.pdf | 鉄道設備、駅周辺開発、老朽化・BCP対応などCRE/インフラ論点が多い。 |
| 野村不動産ホールディングス株式会社 | 不動産業 | https://www.nomura-re-hd.co.jp/english/ir/ir_library/annualreport.html | 不動産開発・保有運営・物流施設など、CRE提案テーマと比較しやすい。 |
| 日本電信電話株式会社 | 情報・通信業 | https://group.ntt/en/ir/library/yuho/ | 通信局舎、データセンター、研究開発、脱炭素投資のCRE論点が多い。 |
| 三菱電機株式会社 | 電気機器 | https://www.mitsubishielectric.com/investors/library/securities_report/index.html | 工場、研究開発、社会インフラ、半導体・データセンター関連設備の論点がある。 |
| 武田薬品工業株式会社 | 医薬品 | https://www.takeda.com/investors/sec-filings-and-security-reports/ | 研究所・製造拠点・品質管理・サステナビリティ投資のCRE仮説を検討しやすい。 |
| 三菱ガス化学株式会社 | 化学 | https://www.mgc.co.jp/eng/ir/library/report.html | 化学プラント、研究開発、半導体材料、脱炭素・安全対策のCRE論点がある。 |
| 東京ガス株式会社 | 電気・ガス業 | https://www.tokyo-gas.co.jp/IR/library/yuho_j.html | エネルギー供給インフラ、脱炭素、供給設備投資、不動産活用の論点がある。 |
...
- `GET /api/companies` が 20 社の合成デモ企業と10社の実在企業デモを返し、`company_id`、`ticker`、`name`、`industry`、`market`、`total_score`、`priority_label`、`signal_count` を含むこと。
